            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if (Session::has('message'))
                        ...
                        @endif
                	<form name="form_input" id="form_input" <?php if (Request::segment(2) == 'edit') { ?> action="{{url('/borrowing/edit') }}/{{$borrower->id}}"<?php }else{ ?> action="{{url('/borrowing/entry') }}" <?php } ?> method="post">
                        {{csrf_field()}}
                        <table id="static_field" width="100%">
                        	<tr>
                        		...
                        		<td rowspan="2">
                                    <div class="form-group">
                                        <textarea type="text" name="remark" class="form-control" style="height: 90px; width: 100%; resize: none" id="remarkField"><?php if (Request::segment(2) == 'edit') { ?>{{$borrower->remark}}<?php } ?></textarea>
