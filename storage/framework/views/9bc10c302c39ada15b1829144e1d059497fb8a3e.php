...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - PFDMGA</title>
...
<body class="fixed-nav sticky-footer bg-light" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="mainNav">
        <a class="navbar-brand" href="/PFDMGA/public/home" style="font-weight: bold;">PFDMGA</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/PFDMGA/public/submission/insert">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/PFDMGA/public/submission/index">
                ...
                <div class="dropdown-divider"></div>
                <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/PFDMGA/public/box/index">
                ...
                <div class="dropdown-divider"></div>
                <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/PFDMGA/public/box/create">
                ...
                <div class="dropdown-divider"></div>
                <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/PFDMGA/public/search">
...
<!--                 <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/search">
                        <i class="fa fa-fw fa-search"></i>
                        <span class="nav-link-text">Change Location</span>
                    </a>
                </li> -->
<!--                 <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/search">
                        <i class="fa fa-fw fa-search"></i>
                        <span class="nav-link-text">Charge Submission</span>
                    </a>
                </li> -->
<!--                 <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/search">
                        <i class="fa fa-fw fa-search"></i>
                        <span class="nav-link-text">Download Report</span>
                    </a>
                </li> -->
                <?php endif; ?>
            </ul>
