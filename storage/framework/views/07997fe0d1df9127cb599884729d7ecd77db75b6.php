    ...
    <tbody align="center">
        <?php $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td>
                    <?php if(isset ($subm->receivedDate)): ?>
                        <?php echo e(date('d-m-Y', strtotime($subm->receivedDate))); ?>                        
                    <?php else: ?>
                        <?php echo e("Unidentified"); ?>

                    <?php endif; ?>
                </td>
                <td><?php echo e($subm->quantity); ?></td>
                <td>
                    <?php if(isset ($subm->empNbr)): ?>
                        <?php echo e($subm->empNbr); ?>
                ...
                <td>
                    <?php if(isset ($subm->signed)): ?>
                        <?php echo e($subm->signed); ?>
