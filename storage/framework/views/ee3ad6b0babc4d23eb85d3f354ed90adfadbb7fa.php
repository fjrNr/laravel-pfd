    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form name="form_input" id="form_input" <?php if (Request::segment(2) == 'edit') { ?> action="<?php echo e(url('/request/edit')); ?>/<?php echo e($request->id); ?>"<?php }else{ ?> action="<?php echo e(url('/request/entry')); ?>" <?php } ?> method="post">
                        ...
                        <table id="static_field" width="100%">
                            <tr>
                                ...
                                <td rowspan="3">
                                    <div class="form-group">
                                        <textarea type="text" name="remark" class="form-control" style="height: 140px; width: 100%; resize: none" id="remarkField"><?php if (Request::segment(2) == 'edit') { ?><?php echo e($borrower->remark); ?><?php } ?></textarea>
