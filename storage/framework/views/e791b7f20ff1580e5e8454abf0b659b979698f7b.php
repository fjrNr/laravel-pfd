	        ...
	        <div class="col-md-12">
	            <div class="card">
	                <div class="card-header">
	                	View Items Borrwoings<a href="<?php echo e(url('/borrowing/entry')); ?>" style="font-weight: bold; float: right;" class="btn btn-success"> &#xff0b; Borrowing</a>
	                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            var oTable = $('#myTable').DataTable({
                ...
                "serverSide": true,
                "ajax" : {
                    "url" : "<?php echo e(URL::to('borrowing/getData')); ?>",
                    "data" : function (d){
                        d.role = 0;
                    },
                },
