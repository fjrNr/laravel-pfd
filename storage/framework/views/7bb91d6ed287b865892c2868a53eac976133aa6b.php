...
<body class="fixed-nav sticky-footer bg-light" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="mainNav">
        <a class="navbar-brand" href="/home" style="font-weight: bold;">Post Flight Document</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/post-flight/public/submission/insert">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/post-flight/public/submission/index">
                ...
                <div class="dropdown-divider"></div>
                <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/post-flight/public/box/index">
                ...
                <div class="dropdown-divider"></div>
                <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/post-flight/public/box/create">
                ...
                <div class="dropdown-divider"></div>
                <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/post-flight/public/search">
...
<!--                 <li class="nav-item" data-toggle="tooltip" data-placement="right">
                ...
                <?php endif; ?>
                <li class="nav-item" data-toggle="tooltip" data-placement="right">
                    <a class="nav-link" href="/post-flight/public/changePass">
