	        ...
	        <div class="col-md-8">
	            <div class="card">
	                ...
	                <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form method="POST" action="/post-flight/public/changePass">
                            <?php echo csrf_field(); ?>
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right">Current Password</label>

                                <div class="col-md-6">
                                    <input id="password" type="password" class="form-control<?php echo e($errors->has('currentPassword') ? ' is-invalid' : ''); ?>" name="currentPassword" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password" class="form-control<?php echo e($errors->has('newPassword') ? ' is-invalid' : ''); ?>" name="newPassword" required>
