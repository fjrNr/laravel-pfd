...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><?php if (Request::segment(2) == 'edit') { ?>Edit<?php }else{ ?>Entry<?php } ?> Items Borrowing</div>
                ...
                <div class="card-body">
                    <?php if(Session::has('message')): ?>
                        ...
                        <?php endif; ?>
                	<form name="form_input" id="form_input" <?php if (Request::segment(2) == 'edit') { ?> action="<?php echo e(url('/borrowing/edit')); ?>/<?php echo e($borrower->id); ?>"<?php }else{ ?> action="<?php echo e(url('/borrowing/entry')); ?>" <?php } ?> method="post">
                        ...
                        <table id="static_field" width="100%">
                        	<tr>
                        		...
                        		<td>
                        			<div class="form-group">
                                        <input type="text" name="empName" id="empNameField" class="form-control" required <?php if (Request::segment(2) == 'edit') { ?> value="<?php echo e($borrower->empName); ?>"<?php } ?>
                                        autofocus>
                        		...
                        		<td rowspan="2">
                                    <div class="form-group">
                                        <textarea type="text" name="remark" class="form-control" style="height: 90px; width: 100%; resize: none" id="remarkField"><?php if (Request::segment(2) == 'edit') { ?><?php echo e($borrower->remark); ?><?php } ?></textarea>
                        	...
                        	<tr>
                        		...
                        		<td>
                        			<div class="form-group">
	                        			<input type="text" id="empUnitField" name="empUnit" class="form-control" required maxlength="10" <?php if (Request::segment(2) == 'edit') { ?> value="<?php echo e($borrower->empUnit); ?>"<?php } ?>>
                        ...
                        <table class="table table-bordered" id="dynamic_field" align="center">
                            ...
                            <tbody>
                                <tr id="row0">
                                    <td><input type="text" name="formNo[0]" class="form-control" maxlength="6" required pattern="([0-9]+){4,7}"></td>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#add").click(function () {
            if($('#formSelect').val() == '0'){
                ...
                $('#dynamic_field').append('<tr id="row'+i+'">\n' +
                    '<td><input type="text" name="formNo['+i+']" class="form-control" maxlength="6" required pattern="([0-9]+){4,7}"></td>\n' +
        ...
        $(document).on('keydown', "input[name^='AFLNo']", function(){
            $(this).autocomplete({
                source: "<?php echo e(URL::to('log/search')); ?>",
                select:function(key, value){
