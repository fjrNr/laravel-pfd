            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if(Session::has('message')): ?>
                        ...
                        <?php endif; ?>
                	<form name="form_input" id="form_input" <?php if (Request::segment(2) == 'edit') { ?> action="<?php echo e(url('/submission/edit')); ?>/<?php echo e($submission->id); ?>"<?php }else{ ?> action="<?php echo e(url('/submission/entry')); ?>" <?php } ?> method="post">
                        ...
                        <table id="static_field" width="100%">
                            ...
                            <tr>
                                ...
                                <td rowspan="4">
                                    <div class="form-group">
                                        <textarea type="text" name="remark" id="remarkField" class="form-control text" style="height: 200px; width: 100%; resize: none" tabindex="5"><?php if (Request::segment(2) == 'edit') { ?><?php echo e($submission->remark); ?><?php } ?></textarea>
                        ...
                        <table class="table table-bordered" id="dynamic_field" align="center" style="display: block; overflow-x: auto;">
                            ...
                            <tr id="row<?php echo e($loop->iteration); ?>" class="baris">
                                <td><input type="text" name="aflNbr[<?php echo e($loop->iteration); ?>]" id="aflNoField<?php echo e($loop->iteration); ?>" class="text form-control" style="width:95px" maxlength="9" required pattern="[0-9]{2}[A-Za-z]{2}[0-9]{4}[A-Z]?" value="<?php echo e($lg->aflNbr); ?>" ></td>
...
<!-- <script type="text/javascript" src="<?php echo e(asset('public/js/entryScript.js')); ?>"></script>-->
