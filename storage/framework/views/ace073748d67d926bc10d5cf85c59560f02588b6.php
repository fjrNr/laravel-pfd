            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if(Session::has('message')): ?>
                        ...
                        <?php endif; ?>
                	<form name="form_input" id="form_input" action="<?php echo e(url('/submission/insert')); ?>" method="post">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group" >
                                        <input type="text" name="formNumber" id="formNoField" class="form-control text" maxlength="5" style="width: 30%" tabindex="1" required pattern="([0-9]+){4,5}" <?php if (Request::segment(2) == 'edit') { ?>
                                                    value="<?php echo e($submission->formNumber); ?>"
                                            <?php } ?>
                                        >
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <?php if (Request::segment(2) == 'edit') { ?>value="<?php echo e($submission->empnbr); ?>"<?php } ?>
                                        >
        ...
        $(document).on('keydown', 'input, textarea', function(e) {
            if (e.keyCode == 13 || e.which == 13) {
                ...
                if ($(this).parent().parent().is(".baris:first")) {
                    window.scrollTo(0,0);
                    $('#remarkField').select();
                } else if ($(this).is("input[name^='aflNumber']") || $(this).is('.checkbox') || $(this).is('.btn-remove')){
                    window.scrollBy(0,-63);
                    if($(this).is("input[name^='aflNumber']")){
                        $(this).closest('tr').prev().find('td:eq(' + $(this).closest('td').index() + ')').find("input[name^='aflNumber']").select();    
                    }else{
                ...
                if ($(this).is('#formNoField')) {
                    ...
                    $('#remarkField').select();
                } else if ($(this).is("input[name^='aflNumber']")){
                ...
                if ($(this).is('#remarkField')) {
                    ...
                    window.scrollBy(0,63);
                    if($(this).is("input[name^='aflNumber']")){
                        $(this).closest('tr').next().find('td:eq(' + $(this).closest('td').index() + ')').find("input[name^='aflNumber']").select();    
                    }else{
